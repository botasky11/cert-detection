...
Figure 1 shows the ROC curves of the two approaches. The R-GCN curve stays closer to the upper-left corner, indicating a consistently higher true positive rate and lower false positive rate across thresholds.

![Precision-Recall Curve Comparison](outputs/comparison/fig_pr_comparison.png)
...
![Top-K Precision and Recall Comparison](outputs/comparison/fig_topk_comparison.png)
...
![Scenario-Level Recall Comparison](outputs/comparison/fig_scenario_comparison.png)
...
![N-gram ROC and PR Curves](outputs/fig_roc_pr.png)

Figure 5 shows the N-gram approach's standalone ROC and PR curves. The method has reasonable overall ranking ability, but its PR curve drops quickly in high-recall regions under sparse positive samples.

![N-gram Top-K Precision and Recall](outputs/fig_topk.png)
...
![N-gram Top-30 Detector Contribution](outputs/fig_top30_contribution.png)

Figure 8 shows the contribution of the four N-gram detectors among the Top-30 high-risk users. Black borders mark true malicious users, illustrating how some malicious users are elevated by multiple detectors while some benign users receive high scores due to rule or rare-token matches.

![N-gram Scenario Coverage](outputs/fig_scenario_breakdown.png)

Figure 9 shows N-gram scenario coverage within the Top-80 users. S1 and S3 rule hits are more concentrated, while S2 coverage remains weak, consistent with the scenario-level recall results.

![N-gram Malicious User Rank Distribution](outputs/fig_malicious_ranks.png)
...
![Dual-Algorithm Risk Score Distribution Comparison](outputs/comparison/fig_score_dist_comparison.png)
...
| --- | --- | --- |
| Figure 1 | Dual-algorithm ROC curve comparison | `outputs/comparison/fig_roc_comparison.png` |
| Figure 2 | Dual-algorithm Precision-Recall curve comparison | `outputs/comparison/fig_pr_comparison.png` |
| Figure 3 | Dual-algorithm Top-K Precision/Recall comparison | `outputs/comparison/fig_topk_comparison.png` |
| Figure 4 | Dual-algorithm scenario-level Recall comparison | `outputs/comparison/fig_scenario_comparison.png` |
| Figure 5 | N-gram ROC and PR curves | `outputs/fig_roc_pr.png` |
| Figure 6 | N-gram Top-K Precision and Recall | `outputs/fig_topk.png` |
| Figure 7 | N-gram risk score distribution | `outputs/fig_risk_distribution.png` |
| Figure 8 | N-gram Top-30 detector contribution | `outputs/fig_top30_contribution.png` |
| Figure 9 | N-gram scenario coverage | `outputs/fig_scenario_breakdown.png` |
